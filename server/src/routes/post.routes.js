...
router.delete('/:postId/message/:id', verifyPost.isModOrAdminOrSameUser,postCtrl.deleteMessage)
router.put('/message/:id',  verifyPost.isModOrAdminOrSameUser,postCtrl.updateMessage)
