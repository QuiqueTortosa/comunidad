...
export default function Auth() {
  ...
  return (
    <div  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-3xl shadow-3xl">
      <form className="flex flex-col justify-center w-96 h-auto rounded-3xl p-16 sm:w-80" onSubmit={handleLogin}>
        ...
        <div className="max-w-[212px] ml-[38px] max-h-[100px]">
          ...
          <FaIcons.FaEye className={`relative ml-2 -top-12 left-[210px] sm:left-[150px] ${showPassword ? "" : "opacity-40"}`} onClick={() => setShowPassword(!showPassword)}/>
        </div>
